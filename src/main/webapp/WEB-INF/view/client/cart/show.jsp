                    ...
                    <tr>
                        ...
                        <th scope="row">
                            <div class="d-flex align-items-center">
                                <img src="/images/books/${cartDetail.book.image}"
                        ...
                        <td>
                            <p class="mb-0 mt-4">
                                <a href="/book/${cartDetail.book.id}" target="_blank">
                                        ${cartDetail.book.name}</a>
                            </p>
                        ...
                        <td>
                            <p class="mb-0 mt-4" data-cart-detail-id="${cartDetail.id}">
                                <fmt:formatNumber
                                        value="${cartDetail.price*cartDetail.quantity}" /> VNĐ
                            </p>
                        </td>
            ...
            <div class="mt-5 row g-4 justify-content-start">
                ...
                <div class="bg-light rounded">
                    <div class="p-4">
                        ...
                        <p class="mb-0 text-end">Nhà Bè, TP HCM</p>
                    </div>
                    ...
                    <%--@elvariable id="cart" type="com.example.bookshop.domain.Cart"--%>
